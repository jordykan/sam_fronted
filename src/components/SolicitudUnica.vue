...
<br>
                            ...
                            <br>
                            <label id="texto">Reviso :</label> <label id="texto">{{aprobacionAmls}}</label><br>
                            
                             <label id="texto">Aprobo :</label> <label id="texto">{{aprobacionApi}}</label>
      ...
      <template v-slot:item.etd="{ item }">
          {{  item.etd | moment("dddd Do MMMM YYYY, h:mm:ss a")}}
      </template>
    ...
    <v-container grid-list-sm class="pa-4 white" v-if="verNuevo">
      <h3>Solicitud unica de acceso</h3>
        <v-layout row wrap>       
            ...
            <v-flex xs11 sm11 lg11 x11>
              <div>
                ...
                >
                         ...
                         <v-row no-gutters>
                             <v-col cols="4">
                              ...
                              <v-col cols="8" class="text--secondary">
                                 <v-text-field class="pa-0" v-model="agenciasUsuario.nombre" readonly  hide-details></v-text-field>
                              </v-col>
                               ...
                               <v-col cols="4">
                                ...
                                <v-col cols="8" class="text--secondary">
                                 <v-text-field class="pa-0" v-model="agenciasUsuario.direccion" readonly  hide-details></v-text-field>
                              </v-col>
                               <v-col cols="4">
                                ...
                                <v-col cols="8" class="text--secondary">
                                 <v-text-field class="pa-0" v-model="agenciasUsuario.rfc" readonly  hide-details></v-text-field>
                              </v-col>
                                ...
                                <v-col cols="8" class="text--secondary">
                                 <v-text-field class="pa-0" v-model="agenciasUsuario.email" readonly  hide-details></v-text-field>
                              </v-col>
                  ...
                  <v-expansion-panel>
                    <v-expansion-panel-header>Datos del Buque y Estadia</v-expansion-panel-header>
                    <v-expansion-panel-content>
                              <v-row no-gutters>
                              
                              <v-col cols="4">
                                  <v-subheader class="pa-0">Nombre del Buque</v-subheader>
                              </v-col>
                              
                              <v-col cols="8" class="text--secondary">
                                  <v-autocomplete class="pa-0" hide-details v-model="embarcacion" :items="embarcaciones"  ></v-autocomplete>
                                    <div v-if="submited && !$v.embarcacion.required"><br>
                              ...
                              <v-col cols="4">
                                  <v-subheader class="pa-0">Capitan</v-subheader>
                              </v-col>
                              
                              <v-col cols="8" class="text--secondary">
                                  <v-text-field class="pa-0" hide-details v-model="capitan" clearable="clearable" ></v-text-field ><br>
                                     
                                          <v-alert v-if="submited && !$v.capitan.required" v-model="alert" dismissible color="red" border="left" elevation="1" colored-border icon="error">
                                              <strong>Error</strong> campo capitan debe detener mas caracteres
                                          </v-alert>
                                    
                              </v-col>
                               <v-col cols="4">
                                  <v-subheader class="pa-0">No. de Tripulantes</v-subheader>
                              </v-col>
                              
                              <v-col cols="8" class="text--secondary">
                                   <v-text-field class="pa-0" hide-details v-model="no_tripulantes" type='number' ></v-text-field><br>
                                    <div v-if="submited && !$v.no_tripulantes.required">
                                          <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                                            <strong>Error</strong> numero de tripulantes es requerido
                                          </v-alert>
                                    </div> 
                              </v-col>
                             <v-col cols="4">
                                  <v-subheader class="pa-0">Procedencia</v-subheader>
                              </v-col>
                              
                              <v-col cols="8" class="text--secondary">
                                   <v-autocomplete class="pa-0" hide-details :items="procedencias" v-model="procedencia" ></v-autocomplete> <br>
                                    <div v-if="submited && !$v.procedencia.required">
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> ETA es requerido
                  </v-alert>
             </div>   
                              </v-col>
                               <v-col cols="4">
                                  <v-subheader class="pa-0">Muelle de arribo</v-subheader>
                              </v-col>
                              
                              <v-col cols="8" class="text--secondary">
                                  <v-autocomplete :items="muelles"  v-model="muelle" class="pa-0" hide-details></v-autocomplete><br>
                               ...
                               <v-col cols="4">
                                  <v-subheader>E.T.A.</v-subheader>
                              </v-col>
                              
                              <v-col cols="8" class="text--secondary">
                                  <v-datetime-picker class="pa-0" hide-details  v-model="eta" > </v-datetime-picker><br>
                                    <div v-if="submited && !$v.eta.required">
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> ETA es requerido
                  </v-alert>
             </div>   
                              ...
                              <v-col cols="4">
                                  <v-subheader >E.T.D.</v-subheader>
                              </v-col>
                              
                              <v-col cols="8" class="text--secondary">
                                  <v-datetime-picker class="pa-0" hide-details   v-model="etd"> </v-datetime-picker><br>
                                   <div v-if="submited && !$v.etd.required">
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> ETD es requerido
                  </v-alert>
             </div>      
                              </v-col>
                         </v-row>
                  ...
                  <v-expansion-panel>
                    <v-expansion-panel-header>Uso de infraestructura portuaria</v-expansion-panel-header>
                    <v-expansion-panel-content>
                       <v-row no-gutters>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="infraestructura" value="Pto. Fijo"></v-checkbox>
                              </v-col>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="infraestructura" value="Atraque"></v-checkbox>
                              </v-col>
                               <v-col cols="4">
                                  <v-subheader class="pa-0">Cuota por arribo a embarcaciones menores</v-subheader>
                              </v-col>
                              
                              <v-col cols="2" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="infraestructura" value="Cuota por arribo a embarcaciones menores"></v-checkbox>
                              </v-col>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="infraestructura" value="Pto. Variable"></v-checkbox>
                              </v-col>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="infraestructura" value="Muellaje"></v-checkbox>
                              </v-col>
                               <v-col cols="4">
                                  <v-subheader class="pa-0">Embarque y desembarque de pasajeros</v-subheader>
                              </v-col>
                              
                              <v-col cols="2" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="infraestructura" value="Embarque y desembarque de pasajeros"></v-checkbox>
                              </v-col>
                   ...
                   <v-expansion-panel>
                    <v-expansion-panel-header>Servicios portuarios requeridos</v-expansion-panel-header>
                    <v-expansion-panel-content>
                       <v-row no-gutters>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Piloto"></v-checkbox>
                              </v-col>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Amarre de cabos"></v-checkbox>
                              </v-col>
                               <v-col cols="3">
                              ...
                              <v-col cols="2" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Lubricantes"></v-checkbox>
                              </v-col>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Suministro de agua potable"></v-checkbox>
                              </v-col>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Combustible"></v-checkbox>
                              </v-col>
                               <v-col cols="3">
                              ...
                              <v-col cols="2" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Almacenaje"></v-checkbox>
                              </v-col>
                                <v-col cols="3">
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Recolección de basura"></v-checkbox>
                              </v-col>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Avituallamiento"></v-checkbox>
                              </v-col>
                               <v-col cols="3">
                              ...
                              <v-col cols="2" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="servicios_port" value="Reparaciones a flote"></v-checkbox>
                              </v-col>
                               <v-col cols="2">
                                  <v-subheader class="pa-0">Otro</v-subheader>
                              </v-col>
                                <v-col cols="10" class="text--secondary">
                                   <v-text-field class="pa-0" hide-details v-model="otros_servicios" clearable="clearable" ></v-text-field >
                              </v-col>
                    ...
                    <v-expansion-panel>
                    <v-expansion-panel-header>Tipo de carga:</v-expansion-panel-header>
                    <v-expansion-panel-content>
                       <v-row no-gutters>
                             
                              <v-col cols="2">
                                  <v-subheader class="pa-0">Operacion de:</v-subheader>
                              </v-col>
                               <v-col cols="2">
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="operacion_carga"></v-checkbox>
                              </v-col>
                              ...
                              <v-col cols="1" class="text--secondary">
                                  <v-checkbox  class="pa-0" hide-details v-model="operacion_descarga"></v-checkbox>
                              </v-col>
                               <v-col cols="2">
                              ...
                              <v-col cols="2" class="text--secondary">
                                   <v-text-field class="pa-0" hide-details v-model="total_toneladas" ></v-text-field>
                              </v-col>
                              ...
                              <v-col cols="8" class="text--secondary">
                                   <v-text-field class="pa-0" hide-details v-model="tipo_carga" ></v-text-field>
                              </v-col>
                      ...
                      <v-expansion-panel>
                    <v-expansion-panel-header>Detalles:</v-expansion-panel-header>
                    <v-expansion-panel-content>
                       <v-row no-gutters>
                             
                            
                               <v-col cols="12">
                                  <v-textarea v-model="comentarios"  clearable="clearable" label="Programa de actividades del buque en el puerto"></v-textarea>
                                    <div v-if="submited && !$v.comentarios.minLength">
                                          <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                                            <strong>Error</strong> campo comentarios debe detener mas caracteres
                                          </v-alert>
                                    </div>  
                                    <div v-if="submited && !$v.comentarios.required">
                                          <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                                            <strong>Error</strong> campo comentarios es requerido
                                          </v-alert>
                                    </div>  
                              </v-col>
                              ...
                              <v-col cols="12">
                                   <v-textarea v-model="observaciones"  clearable="clearable" label="Comentarios y observaciones generales"></v-textarea>
                                      
             <div v-if="submited && !$v.observaciones.required">
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> campo observaciones es requerido
                  </v-alert>
             </div>   
             <div v-if="submited && !$v.observaciones.minLength">
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> campo observaciones debe detener mas caracteres
                  </v-alert>
             </div>      
                              </v-col>
  ...
  validations:{
    ...
    data(){
      ...
      readonly: false,
            embarcacion:'',
            embarcaciones:[],
            procedencias:['CARMEN','DOS BOCAS','FRONTERA','TUXPAN','SEYBAPLAYA','AREA DE PLATAFORMAS',],
            nombreCompleto:'',
            agencias:[],
            dialogs:false,
            nombre:'',
      ...
      datos(){
          ...
          console.log(this.embarcacionQuery)
           ...
           enviar(correo,embarcacion,procedencia,solicitante,detalles,eta,etd,muelle,status){
 ...
 emailIn(){
        ...
        this.infraestructura = [...this.infraestructura]
          ...
          guardar(){
            ...
            let configuracion= {headers: header}
              ...
              if(this.editedIndex >-1 ){
               ...
               .then(function(response){
                    swal(
                      "Solicitud Unica Actualizada",
                      "La solicitud unica ha sido actualizada exitosamente",
                      "success"
                    )
                    me.close();
                    me.ocultarNuevo();
                  ...
                  swal(
                      "Error",
                      "La solicitud unica no se ha actualizado favor de llenar los campos correctamente",
                      "warning"
                    )
               ...
               .then(function(response){
                   swal(
                      "Nueva Solicitud Unica"+" SU"+response.data.folio_solicitud,
               ...
               me.close();
                 ...
                 me.listar();   
                  ...
                  swal(
                      "Error",
                      "La solicitud unica no se ha agregado favor de llenar los campos correctamente"+error,
                      "error"
                    )
         ...
         listarUsuario(idSolicitud){
          ...
          let configuracion= {headers: header}
          let me=this
          axios.get('usuario/query?='+idServicio,configuracion).then(function (response){
          ...
          listar(){
            ...
            let configuracion= {headers: header}
            let me=this;
            axios.get('solicitudUnica/list?valor='+this.$store.state.usuario._id,configuracion).then(function (response){
         ...
         listarEmbarcacion(correo,embarcacion,procedencia,usuario,detalles,eta,etd,muelle,estado){
            let header={"Token":this.$store.state.token};
            let me=this;
          ...
          listarAgenciaQuery(idA,idE){
            ...
            axios.get('agencia/query?_id='+idA,configuracion).then(function (response){
            me.agencias=response.data;
            
            }).catch(function(error){
              console.log(error)
            })
            axios.get('embarcacion/query?_id='+idE,configuracion).then(function (response){
