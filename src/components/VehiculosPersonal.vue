                      ...
                      <table style="width: 100%; height: 50px;">
                        <tbody>
                          <tr>
                            ...
                            <td id="texto" style="border-bottom: .5px solid">{{nombreCompleto}}</td>
                          </tr>
      ...
      <template v-slot:item.action="{ item }">
       ...
       <v-icon
        ...
        <v-icon
          small
          class="mr-2"
          @click="descargarManifiesto(item)"
        >
fa fa-file-pdf-o
        </v-icon>
      </template>
        ...
        <v-layout row wrap>
           ...
           <v-flex xs11 sm11 lg11 x11>
                ...
                >
                                ...
                                <v-col cols="8" class="text--secondary">
                                 ...
                                 <v-flex xs12 sm12 lg12 x12>
                                    <v-radio-group v-model="tipo" row>
                                          <v-radio label="Prestador de Servicios" value="Prestador de Servicios"></v-radio>
                  ...
                  <v-expansion-panel>
                    ...
                    <v-expansion-panel-content>
                              ...
                              <v-col cols="4">
                                  <v-subheader class="pa-0">Periodo de la estadia</v-subheader>
                              </v-col>
                  ...
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> campo fecha es requerido
                              ...
                              <v-col cols="8" class="text--secondary">
                                   <v-autocomplete :items="muelles"   v-on="on" class="pa-0" hide-details v-model="muelle" ></v-autocomplete><br>
                  ...
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> campo muelle es requerido
                                ...
                                <v-col cols="8" class="text--secondary">
                                   <v-flex xs1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 2 sm12 lg12 x12>
                                        <v-container >
                                      <v-checkbox v-model="ingreso_mat" label="Ingreso de material o equipo"></v-checkbox>
                                      <v-checkbox v-model="retiro_mat" label="Retiro de material o equipo"></v-checkbox>
                                    </v-container>
                                </v-flex>
                              </v-col>
                  ...
                  <v-expansion-panel>
                    ...
                    <v-expansion-panel-content>
                              ...
                              <v-col cols="8" class="text--secondary">
                                  <v-autocomplete  v-model="embarcacion"  class="pa-0" hide-details :items="embarcaciones"  ></v-autocomplete><br>
                  ...
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> campo embarcacion es requerido
                              ...
                              <v-col cols="8" class="text--secondary">
                        <v-text-field v-model="compania" label="Compañia"></v-text-field><br>
                                   ...
                                   <v-flex xs12 sm2 md2 lg2 x12>
                                        <v-btn small fab dar color="" @click="agregarDetalle()">
                                          ...
                                          <v-flex xs12 sm12 md12 lg12 xl12>
                                              ...
                                              >
                                                      <template slot="items" slot-scope="props">
                                                        ...
                                                        <td class="text-xs-center"><v-text-field v-model="props.items.compania"></v-text-field></td>

                                                        <td class="text-xs-center"><v-text-field v-model="props.items.puesto"></v-text-field></td>
                                                        <td class="text-xs-center"><v-text-field v-model="props.items.licencia"></v-text-field></td>
                                          ...
                                          <template  v-slot:item.compania="{ item }">
                                            <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.compania"></v-text-field> </td>
                                          </template>
                                        <template  v-slot:item.puesto="{ item }">
                                            <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.puesto"></v-text-field> </td>
                                          </template>
                                          <template  v-slot:item.licencia="{ item }">
                                            <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.licencia"></v-text-field> </td>
                                          </template>
                  ...
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    ...
                    <v-expansion-panel>
                    <v-expansion-panel-header>Lista de Vehiculos</v-expansion-panel-header>
                    <v-expansion-panel-content>
                              <v-row no-gutters>
                                <v-col cols="12" class="text--secondary">
                              <v-flex xs12 sm2 md2 lg2 x12>
                                <v-btn small fab dar color="" @click="agregarVehiculos()">
                                    <v-icon dark>directions_car
                                </v-icon>
                                </v-btn>
                 ...
                 >
                        <template slot="items" slot-scope="props">
                          <td class="text-xs-center"><v-text-field v-model="props.items.marca"></v-text-field></td>
                          <td class="text-xs-center"><v-text-field v-model="props.items.placa"></v-text-field></td>
                          <td class="text-xs-center"><v-text-field v-model="props.items.vigenciaSeguro"></v-text-field></td>
                          <td class="text-xs-center"><v-text-field v-model="props.items.color"></v-text-field></td>
                          <td class="text-xs-center"><v-text-field v-model="props.items.tipo"></v-text-field></td>
                          <td class="text-xs-center"><v-text-field v-model="props.items.compania_aseguradora"></v-text-field></td>
             ...
             <template  v-slot:item.borrar="{ item }">
                 <v-icon
                    small
                    @click="eliminarVehiculo(vehiculos,item)"
                    >
                    delete
                 </v-icon>
            </template>
            ...
            <template  v-slot:item.marca="{ item }">
                 <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.marca"></v-text-field></td>
            </template>
            <template  v-slot:item.placa="{ item }">
                 <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.placa"></v-text-field></td>
            </template>
             <template  v-slot:item.vigenciaSeguro="{ item }">
                 <td class="text-xs-center"><input type="date" clearable="clearable" v-model="item.vigenciaSeguro"></td>
            </template>
             <template  v-slot:item.color="{ item }">
                 <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.color"></v-text-field></td>
            </template>
             <template  v-slot:item.tipo="{ item }">
                 <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.tipo"></v-text-field></td>
            </template>
             <template  v-slot:item.compania_aseguradora="{ item }">
                 <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.compania_aseguradora"></v-text-field></td>
            </template>
             ...
             <v-flex xs12 sm4 lg4 x14>
              ...
              <v-col v-if="ingreso_mat==true || retiro_mat==true" cols="12" sm="12" md="12">Adjunte el manifiesto de materiales: <br>
                 <input type="file"  id="file" ref="file" name="file0" v-on:change="handleFileUploadManifiesto()" label="File input"/><br>
              </v-col>
  ...
  <v-divider></v-divider>
             ...
             <v-flex xs12 sm2 md12 lg12 xl12>
               <template>
                        ...
                        <v-col cols="12" v-if="vehiculos.length > 0" sm="12" md="12">Adjunte los archivos de los vehiculos: <br>
                        <input type="file"  id="file1" ref="file1" name="file1" v-on:change="handleFileUploadVehiculos()" label="File input"/><br>
                        ...
                        <v-col cols="12" sm="12" md="12">Adjunte los archivos del personal: <br>
                        <input type="file"   id="file3" ref="file3" name="file3" v-on:change="handleFileUploadPersonal()" label="File input"/><br>
                        </v-col>
                          <div v-if="submited && !$v.file3.required">
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong>Adjunto de personal es requerido 
                  </v-alert>
             </div>   
                        
                          
                           <v-flex xs12 sm12 lg12 x14>
                         <v-textarea v-model="detalles"  clearable="clearable" label="Motivo de la visita"></v-textarea><br>
                            <div v-if="submited && !$v.detalles.required">
                  <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                    <strong>Error</strong> campo motivo es requerido 
                  </v-alert>
             </div>   
              <div v-if="submited && !$v.detalles.minLength">
                                          <v-alert v-model="alert" dismissible color="red" border="left" elevation="2" colored-border icon="error">
                                            <strong>Error</strong> campo detalles debe detener mas caracteres
                                          </v-alert>
                                    </div>  
...
import {required, email, minLength} from "vuelidate/lib/validators"
  export default {
    ...
    data(){
      return{
            ...
            cabeceraDetalles:[
              ...
              { text: 'Compañia', value: 'compania' },
               ...
               { text: 'No. de Licencia', value: 'licencia' },
          ...
          computed: {
              config(){
                    ...
                    url(){
                      return `${this.baseUrl}/${'datos'}/${this.newFileName}`
                    },
                    url2(){
                      return `${this.baseUrl}/${'datos'}/${this.newFileName2}`
                    },
                     url3(){
                      return `${this.baseUrl}/${'datos'}/${this.newFileName3}`
                    },
          formTitle () {
          ...
          crearPDF(){
            var quotes = document.getElementById('solicitudGuardia')
             html2canvas(quotes).then(function (canvas) {
                    ...
                    doc.save('vehiculosPersonal.pdf');
            })
          },
           imprimir() {
      ...
      emailjs.send("gmail", "vehiculopersonal", template_params).then(
        function(response) {
          if (response.text === "OK") {
          }
          console.log(
      ...
      axios
        ...
        .catch(function(error) {
          console.log(error);
            ...
            let header={"Token":this.$store.state.token};
            let configuracion= {headers: header}
            axios.get('companias/list?agencia='+this.$store.state.usuario.agencia,configuracion).then((response)=>{
              companiaArray=response.data;
              companiaArray.map(function(x){
                me.companias.push({text:x.razon_social, value:x._id})
              });
            }).catch(function(error){
              console.log(error);
            })
          ...
          guardar(){
             ...
             if(this.editedIndex >-1 ){    
               ...
               if(me.file2){
                  let file2=me.file2
                  let fileExtension2 = file2.type.split('/')[1]

                
                  this.nombreArchivo2 = `${me.url2}.${fileExtension2}`
               }
               if(me.file3){
                  let file3=me.file3
                  let fileExtension3 = file3.type.split('/')[1]

                 

                  this.nombreArchivo3 = `${me.url3}.${fileExtension3}`
               }
               
                axios.put('vehiculoPersonal/actualizar',{
                  '_id':this._id,
                  ...
                  'vehiculos':this.vehiculos,
                   'manifiesto': this.nombreArchivo,
                   'vehiculos_adj':this.nombreArchivo2,
                   'personal_adj':this.nombreArchivo3,
                   'tipo':this.tipo,
               ...
               .then(function(response){
                  if(me.file){
                     me.S3Client
                    .uploadFile(me.file, me.newFileName)
                    
                  }
                  console.log(me.newFileName)
                   if(me.file2){
                     me.S3Client
                    .uploadFile(me.file2, me.newFileName2)
                  }
                    if(me.file3){
                     me.S3Client
                    .uploadFile(me.file3, me.newFileName3)
                  }
               ...
               .catch(function(error){
                 ...
                 swal(
                   "Error",
                   "Error al ingresar la solicitud, verifica los datos ingresados",
                   "error"
                 )
               });
             }else{
               ...
               .then(function(response){
                ...
                me.ocultarNuevo();
                 ...
                 swal(
                   "Error",
                   "Error al ingresar la solicitud, verifique los datos ingresadoss",
                   "error"
                 )
               });
              }
          ...
          listar(){
            ...
            let configuracion= {headers: header}
            let me=this;
            axios.get('vehiculoPersonal/list?valor='+this.$store.state.usuario._id,configuracion).then(function (response){
          ...
          editItem (item) {
            ...
            download(item){
               axios.get('vehiculoPersonal/getAccesoManifiesto/'+item.manifiesto, {responseType: 'arraybuffer'}).then(function (response){
              ...
              downloadPersonal(item){
               axios.get('vehiculoPersonal/getAccesoPersonal/'+item.personal_adj, {responseType: 'arraybuffer'}).then(function (response){
               let blob = new Blob([response.data],{ type:'content-type'});
               let link = document.createElement('a');
               link.href = window.URL.createObjectURL(blob);
             ...
             downloadVehiculo(item){
               axios.get('vehiculoPersonal/getAccesoVehiculo/'+item.vehiculos_adj, {responseType: 'arraybuffer'}).then(function (response){
               let blob = new Blob([response.data],{ type:'content-type'});
               let link = document.createElement('a');
               link.href = window.URL.createObjectURL(blob);
               link.download = "personal.pdf";
